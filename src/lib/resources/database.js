...
var Database = /** @class */ (function () {
     ...
     */
    Database.setup = function (uri) {
        if (uri === void 0) { uri = process.env.MONGODB_URI; }
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.mongooseClient) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, mongoose_1["default"].connect(uri)];
                    case 1:
                        _a.mongooseClient = _b.sent();
                        _b.label = 2;
                    case 2: return [2 /*return*/, this.mongooseClient];
                }
            });
        });
    };
    ...
    */
    Database.setupAdapterConnection = function (uri) {
        if (uri === void 0) { uri = process.env.MONGODB_URI; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.mongoClientPromise) {
                    this.mongoClientPromise = mongodb_1.MongoClient.connect(uri);
                }
                return [2 /*return*/, this.mongoClientPromise];
            });
        });
    };
    return Database;
